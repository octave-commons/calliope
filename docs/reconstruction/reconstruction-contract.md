...
{:contract/id :fork-tales/audio-reconstruction-auditor
 ...
 :runtime/entrypoint "scripts/reconstruction/audio_agent.cljs"
...
```json
{
  ...
  "metrics": {
    "tool": "scripts/reconstruction/audio_metrics.py",
    "json": "path",
...
- `/home/err/Music/fork-tales/references/heresy-between/reconstructions/openutau/heresy-between-exact-phrase-grid-openutau-v16.wav`
- `/home/err/Music/fork-tales/references/heresy-between/reconstructions/openutau/heresy-between-exact-phrase-grid-openutau-v16.json`
