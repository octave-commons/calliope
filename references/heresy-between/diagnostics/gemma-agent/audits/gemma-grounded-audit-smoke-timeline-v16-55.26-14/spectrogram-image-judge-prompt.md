...
- audit_id: `gemma-grounded-audit-smoke-timeline-v16-55.26-14`
- profile: `suno_reverse_accuracy`
- evidence_json: `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/evidence.json`
- start_seconds: `55.26`
- duration_seconds: `14`
- expected lyric clue: `タイムラインには知らない誰かの笑顔 強がってスクロールして心だけ取り残す`

## Noisy Non-Image Context

This context is provided only to orient the segment. Do not let it override the images.

- local STT original: `タイムラインには知らない誰かの笑顔強がってスクロールして心だけ取り残す打ち掛けの言葉が震えて消えてくたび`
- local STT candidate: `タイムラインに走らない誰かの笑顔強がってスクロールして心だけ取り残す打ち明けの言葉が震えて消えてくタイム`
- numeric pitch summary: `{'voiced_overlap_ratio': 0.7495854063018242, 'cents_error': {'count': 904, 'mean': -363.3628318584071, 'median': -320.00000000000006, 'min': -1249.9999999999998, 'max': 430.0000000000002, 'p05': -1028.5, 'p95': 189.99999999999972}, 'mean_abs_cents': 411.3274336283186, 'f0_hz_correlation': 0.07952894947985584}`
- numeric spectrogram summary: `{'mel_db_mean_abs_diff': 17.661590576171875, 'mel_db_rmse': 22.070438385009766, 'mel_db_correlation': 0.09123148303660446}`

## Attach / Inspect Images In This Order

1. `f0_overlay` — `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.f0-overlay.png` — Original and candidate f0 contours overlaid on the same axes. — exists=True
2. `mel_diff` — `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.mel-diff.png` — Candidate minus original mel-spectrogram dB difference. — exists=True
3. `original_f0` — `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.original.f0.png` — Original/reference f0 contour. — exists=True
4. `candidate_f0` — `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.candidate.f0.png` — Candidate/render f0 contour. — exists=True
5. `original_mel` — `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.original.mel.png` — Original/reference mel spectrogram. — exists=True
6. `candidate_mel` — `/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.candidate.mel.png` — Candidate/render mel spectrogram. — exists=True
...
```json
{
  ...
  "image_refs": [
    {
      "role": "f0_overlay",
      "path": "/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.f0-overlay.png"
    },
    {
      "role": "mel_diff",
      "path": "/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.mel-diff.png"
    },
    {
      "role": "original_f0",
      "path": "/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.original.f0.png"
    },
    {
      "role": "candidate_f0",
      "path": "/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.candidate.f0.png"
    },
    {
      "role": "original_mel",
      "path": "/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.original.mel.png"
    },
    {
      "role": "candidate_mel",
      "path": "/home/err/devel/Music/fork-tales/references/heresy-between/diagnostics/gemma-agent/audits/gemma-grounded-audit-smoke-timeline-v16-55.26-14/metrics.candidate.mel.png"
    }
  ],
  "global_observations": [],
  "feature_judgments": [
